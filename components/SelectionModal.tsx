          ...
          <div className="flex flex-wrap gap-2">
            {POSITIONS.map(pos => (
              <button
                ...
                className={`px-4 py-2 rounded-xl text-[10px] font-black uppercase transition-all ${posFilter === pos ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/30' : 'bg-slate-100 text-slate-400 hover:bg-slate-200'}`}
              >
                {pos}
              </button>
            ))}
