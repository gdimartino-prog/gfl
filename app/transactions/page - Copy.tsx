    ...
    <div className="max-w-7xl mx-auto p-8 space-y-12">
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center border-b pb-2">
          ...
          <button 
            onClick={fetchLogs}
            className="text-xs bg-gray-200 hover:bg-gray-300 px-3 py-1 rounded transition flex items-center gap-2"
          >
            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y">
                {loadingLogs ? (
                  ...
                  <tr><td colSpan={5} className="p-10 text-center text-gray-400">No transactions recorded yet.</td></tr>
                ) : (
                  logs.map((log, i) => (
