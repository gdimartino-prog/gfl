                        ...
                        {isDrafted ? (
                          <div className="flex flex-col">
                            <div className="flex items-center gap-2">
                              ...
                              <a href={`https://www.google.com/search?q=${encodeURIComponent(pick.draftedPlayer.split(' - ')[0].trim())}`} target="_blank" rel="noopener noreferrer" className="text-base font-black uppercase text-slate-900 hover:text-blue-600 transition-all">
                                {pick.draftedPlayer}
                              </a>
                            </div>
