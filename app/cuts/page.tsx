          ...
          <div className="sticky top-6 z-50 bg-[#0f172a] shadow-[0_20px_50px_rgba(0,0,0,0.3)] p-5 rounded-[2.5rem] flex flex-col md:flex-row justify-between items-center px-10 border border-slate-700 gap-6">
             ...
             <div className="flex-1 max-w-xl w-full">
                <div className="relative">
                  ...
                  />
                  <div className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-500 text-[10px] font-black uppercase tracking-widest hidden sm:block">Filter</div>
                </div>
             </div>
             ...
             <button 
               ...
               className="bg-blue-600 hover:bg-blue-500 disabled:bg-slate-700 text-white px-12 py-5 rounded-2xl font-black uppercase text-xs transition-all shadow-xl active:scale-95 flex items-center gap-3"
             >
               {saving ? <span className="animate-spin text-lg">◌</span> : null}
                ...
                <div key={p.identity} className="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100 flex flex-col sm:flex-row justify-between items-center group hover:shadow-xl hover:border-blue-100 transition-all duration-300 gap-4">
                  <div className="text-center sm:text-left">
                    ...
                    <div className="flex items-center gap-3 mt-2 justify-center sm:justify-start">
                      <span className="text-[11px] font-black text-blue-600 bg-blue-50 px-2 py-0.5 rounded-md uppercase">{p.position}</span>
